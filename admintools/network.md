...
* [interface](network.md#interface)
  * [change interface name](network.md#change-interface-name)
  * [show](network.md#show)
* [route](network.md#route)
* [DNS](network.md#dns)
  * [add new DNS permanently](network.md#add-new-dns-permanently)
* [Port Redirection](network.md#port-redirection)
* [proxy setup](network.md#proxy-setup)
* [network speed](network.md#network-speed)
* [wifi](network.md#wifi)
  * [`iwconfig`](network.md#iwconfig)
  * [nmcli](network.md#nmcli)
  * [nmtui](network.md#nmtui)
...
![nmcli-1](../.gitbook/assets/nmcli-1.png)
...
![nmcli-2](../.gitbook/assets/nmcli-2.png)
...
![nmtui-1](../.gitbook/assets/nmtui-1.png) ![nmtui-2](../.gitbook/assets/nmtui-2.png)
