...
* [nginx](nginx-and-cert.md#nginx)
  * [installation](nginx-and-cert.md#installation)
  * [configuration](nginx-and-cert.md#configuration)
* [ssl cert](nginx-and-cert.md#ssl-cert)
  * [generate cert for server](nginx-and-cert.md#generate-cert-for-server)
  * [check certs](nginx-and-cert.md#check-certs)
* [cert in Nginx](nginx-and-cert.md#cert-in-nginx)
* [cert in os](nginx-and-cert.md#cert-in-os)
  * [MacOS](nginx-and-cert.md#macos)
* [artifactory https](nginx-and-cert.md#artifactory-https)
  * [general SSL certs](nginx-and-cert.md#general-ssl-certs)
