...
* [preconfig](installation.md#preconfig)
  * [install dependencies](installation.md#install-dependencies)
  * [setup account](installation.md#setup-account)
  * [setup MOTD](installation.md#setup-motd)
  * [get subnet ip address](installation.md#get-subnet-ip-address)
  * [get public IP address](installation.md#get-public-ip-address)
* [applications](installation.md#applications)
  * [shadowsocks](installation.md#shadowsocks)
  * [shadowsocks-libev](installation.md#shadowsocks-libev)
  * [terminal configurations](installation.md#terminal-configurations)
  * [vncserver](installation.md#vncserver)
* [artifactory](installation.md#artifactory)
  * [add insecure-regiestry](installation.md#add-insecure-regiestry)
  * [docker login & logout](installation.md#docker-login--logout)
  * [docker pull](installation.md#docker-pull)
  * [docker push](installation.md#docker-push)
* [X Windows](installation.md#x-windows)
  * [get screen solution](installation.md#get-screen-solution)
  * [desktop sharing](installation.md#desktop-sharing)
* [Reference](installation.md#reference)
...
![ss-libev-service](../../.gitbook/assets/ss-libev-port%20%281%29.png)
...
![ss-libev-client](../../.gitbook/assets/ss-libev-client%20%281%29.png)
...
org.gnome.Terminal.Legacy.Keybindings zoom-normal '0'
org.gnome.Terminal.Legacy.Keybindings read-only 'disabled'
org.gnome.Terminal.Legacy.Keybindings new-profile 'disabled'
org.gnome.Terminal.Legacy.Keybindings zoom-out 'minus'
org.gnome.Terminal.Legacy.Keybindings move-tab-left 'Page_Up'
...
org.gnome.Terminal.Legacy.Keybindings zoom-in 'plus'
org.gnome.Terminal.Legacy.Keybindings detach-tab 'disabled'
org.gnome.Terminal.Legacy.Keybindings move-tab-right 'Page_Down'
org.gnome.Terminal.Legacy.Keybindings close-tab 'w'
org.gnome.Terminal.Legacy.Keybindings paste 'v'
org.gnome.Terminal.Legacy.Keybindings reset 'disabled'
org.gnome.Terminal.Legacy.Keybindings new-tab 't'
org.gnome.Terminal.Legacy.Keybindings find-previous 'H'
...
org.gnome.Terminal.Legacy.Keybindings prev-tab 'Page_Up'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-33 'disabled'
org.gnome.Terminal.Legacy.Keybindings find-next 'G'
org.gnome.Terminal.Legacy.Keybindings find 'F'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-1 '1'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-2 '2'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-3 '3'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-4 '4'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-5 '5'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-6 '6'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-7 '7'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-8 '8'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-9 '9'
org.gnome.Terminal.Legacy.Keybindings help 'F1'
org.gnome.Terminal.Legacy.Keybindings copy 'c'
org.gnome.Terminal.Legacy.Keybindings close-window 'q'
org.gnome.Terminal.Legacy.Keybindings new-window 'n'
org.gnome.Terminal.Legacy.Keybindings save-contents 'disabled'
org.gnome.Terminal.Legacy.Keybindings find-clear 'J'
org.gnome.Terminal.Legacy.Keybindings switch-to-tab-10 '0'
...
org.gnome.Terminal.Legacy.Keybindings next-tab 'Page_Down'
```
