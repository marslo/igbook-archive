...
* [combine multiple lines with or without space](tricky.md#combine-multiple-lines-with-or-without-space)
* [search \(in\)sensitive](tricky.md#search-insensitive)
* [list all `filetype`](tricky.md#list-all-filetype)
* [run vim commands in terminal](tricky.md#run-vim-commands-in-terminal)
* [Using vim as a man-page viewer under Unix](tricky.md#using-vim-as-a-man-page-viewer-under-unix)
...
![search-case-sensitive](../../.gitbook/assets/search-ignoreCase.gif)
