...
* [build & current build](build.md#build--current-build)
  * [check previous build status](build.md#check-previous-build-status)
  * [Stop the current build](build.md#stop-the-current-build)
  * [get current build info](build.md#get-current-build-info)
  * [trigger downstream builds](build.md#trigger-downstream-builds)
  * [get changelogs](build.md#get-changelogs)
* [stage and build](build.md#stage-and-build)
  * [`warnError`](build.md#warnerror)
  * [`catchError`](build.md#catcherror)
  * [`error`](build.md#error)
  * [`unstable`](build.md#unstable)
  * [get stage of a build](build.md#get-stage-of-a-build)
* [Build Result](build.md#build-result)
  * [isWorthThan](build.md#isworththan)
...
> [/marslo/sandbox](https://github.com/marslo/ibook/tree/4e73070b856190d1387369d53a614f1eaa6921ad/docs/jenkins/jenkinsfile/properties.html#mixed-parameters)
...
![build downstream jobs](../../.gitbook/assets/trigger-downstream.png)
...
![warnError](../../.gitbook/assets/warnError.png)
...
* or [just be simply](https://github.com/jenkinsci/github-autostatus-plugin/issues/47#issue-479506531):
  ...
  ![catchError](../../.gitbook/assets/catchError.png)
...
* [catchError unstable](https://github.com/marslo/ibook/tree/4e73070b856190d1387369d53a614f1eaa6921ad/docs/screenshot/jenkins/catchError-unstable.png)
...
![Jenkins Result Status](../../.gitbook/assets/Result.isWorthThan.png)
