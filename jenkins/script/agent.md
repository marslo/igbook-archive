...
* [get information](agent.md#get-information)
  * [get all](agent.md#get-all)
  * [`Computer` and `Node`](agent.md#computer-and-node)
  * [get projects tied to agent](agent.md#get-projects-tied-to-agent)
  * [get ip address of node](agent.md#get-ip-address-of-node)
  * [get agent environment variable](agent.md#get-agent-environment-variable)
  * [get a list of all Jenkins nodes assigned with label](agent.md#get-a-list-of-all-jenkins-nodes-assigned-with-label)
  * [check how many cloud agent running](agent.md#check-how-many-cloud-agent-running)
* [Managing Nodes](agent.md#managing-nodes)
  * [Monitor and Restart Offline Agents](agent.md#monitor-and-restart-offline-agents)
  * [Create a Permanent Agent from Groovy Console](agent.md#create-a-permanent-agent-from-groovy-console)
  * [update agent label](agent.md#update-agent-label)
  * [jenkins-scripts/scriptler/disableSlaveNodeStartsWith.groovy](agent.md#jenkins-scriptsscriptlerdisableslavenodestartswithgroovy)
  * [disable agent](agent.md#disable-agent)
  * [disconnect agent](agent.md#disconnect-agent)
  * [offline agent](agent.md#offline-agent)
  * [delete agent](agent.md#delete-agent)
...
* result ![get project\(s\) via agent](../../.gitbook/assets/get-tied-projects-via-agents.png)
* or
...
> * [Display Information About Nodes](https://wiki.jenkins.io/display/jenkins/display+information+about+nodes)
>
> bring node online `computer.setTemporarilyOffline( false, null )`
{% endhint %}
