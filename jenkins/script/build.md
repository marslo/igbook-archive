...
* [jobs](build.md#jobs)
  * [get name and classes](build.md#get-name-and-classes)
  * [list all jobs and folders](build.md#list-all-jobs-and-folders)
  * [list all Abstract Project](build.md#list-all-abstract-project)
  * [find all disabled projects/jobs](build.md#find-all-disabled-projectsjobs)
  * [get single job properties](build.md#get-single-job-properties)
  * [get particular job status](build.md#get-particular-job-status)
  * [list job which running for more than 24 hours](build.md#list-job-which-running-for-more-than-24-hours)
* [build](build.md#build)
  * [build number](build.md#build-number)
  * [get changesets](build.md#get-changesets)
  * [stop builds](build.md#stop-builds)
  * [get build time](build.md#get-build-time)
  * [list all builds within 24 hours](build.md#list-all-builds-within-24-hours)
  * [get last 24 hours failure builds](build.md#get-last-24-hours-failure-builds)
  * [get last 24 hours failure builds via Map structure](build.md#get-last-24-hours-failure-builds-via-map-structure)
* [build parameters](build.md#build-parameters)
  * [get build parameters](build.md#get-build-parameters)
  * [get wanted parameter values in builds](build.md#get-wanted-parameter-values-in-builds)
  * [get only `String` type parameters](build.md#get-only-string-type-parameters)
* [build results](build.md#build-results)
  * [get all builds result percentage](build.md#get-all-builds-result-percentage)
  * [get builds result percentage within 24 hours](build.md#get-builds-result-percentage-within-24-hours)
  * [get builds result during certain start-end time](build.md#get-builds-result-during-certain-start-end-time)
  * [get builds result and percentage within certain start-end time](build.md#get-builds-result-and-percentage-within-certain-start-end-time)
...
> * [hudson.model.AbstractProject](https://javadoc.jenkins-ci.org/hudson/model/AbstractProject.html)
...
#### [cancel builds in same job](https://raw.githubusercontent.com/cloudbees/jenkins%20scripts/master/cancel%20builds%20same%20job.groovy)
...
>
>   final int BENCH\_MARK = 1_24_60_60_1000
>
>   println """
>
>   ```text
...
>   ```
>
>      Date\(NOW-BENCH\_MARK\).format\(\) : ${new Date\(NOW - BENCH\_MARK\).format\("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"\)}
>
>   """
>
> * result:
...
* result:
  ...
  ![get build start time](../../.gitbook/assets/job-get-build-time.png)
...
* result
  ...
  ![build status](../../.gitbook/assets/job-successful-failure-percentage.png)
...
* result
  ...
  ![build status for jobs within 24 hours](../../.gitbook/assets/jobs-status-within-24hours.png)
...
* result:
  ...
  ![filter build history via params](../../.gitbook/assets/filter-job-history-via-params.png)

  ![filter build history via params details](../../.gitbook/assets/filter-job-history-via-params-2.png)
...
* result
  ...
  ![build-history-with-status-and-percentage-for-params](../../.gitbook/assets/build-history-with-status-and-percentage-for-params.png)

  ![build-history-with-status-and-percentage-for-all-builds](../../.gitbook/assets/build-history-with-status-and-percentage-for-all.png)
