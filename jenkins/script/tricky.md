...
* [DSL](tricky.md#dsl)
  * [How do I access Pipeline DSLs from inside a Groovy class?](tricky.md#how-do-i-access-pipeline-dsls-from-inside-a-groovy-class)
* [jobs](tricky.md#jobs)
  * [Create a Permanent Agent from Groovy Console](tricky.md#create-a-permanent-agent-from-groovy-console)
* [agents](tricky.md#agents)
  * [Monitor and Restart Offline Agents](tricky.md#monitor-and-restart-offline-agents)
* [others](tricky.md#others)
  * [run shell scripts in a cluster-operation](tricky.md#run-shell-scripts-in-a-cluster-operation)
  * [get all running thread](tricky.md#get-all-running-thread)
  * [Automate configuring via Jenkins Script Console](tricky.md#automate-configuring-via-jenkins-script-console)
