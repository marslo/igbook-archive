...
* [remove stuck namespace](namespace.md#remove-stuck-namespace)
  * [check which item occupied the resource](namespace.md#check-which-item-occupied-the-resource)
  * [remove challenge.certmanager](namespace.md#remove-challengecertmanager)
* [list](namespace.md#list)
  * [list all namespaces with name only](namespace.md#list-all-namespaces-with-name-only)
  * [list all quota in cluster](namespace.md#list-all-quota-in-cluster)
* [Reference](namespace.md#reference)
